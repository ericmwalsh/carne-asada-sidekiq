...
module Loaders
  class DeterminePrices
    ...
    class << self
      ...
      def run(grouped_prices, fiat_currencies, base_currencies) # arr of hash, hash, arr of string
        converted_markets = {}
        ...
        # split into groups
        grouped_prices.each do |market_hash|
        ...
        base_currencies.each do |bc|
          bc_value = calculate_average_value!(bc, convert_hash)
        ...
        convert_hash.each do |currency, market_hashes|
          ...
          unless converted_currencies[currency].present?
            converted_currencies[currency] = calculate_average_value!(
              currency,
              convert_hash,
              converted_markets
            )
      ...
      def calculate_average_value!(bc, convert_hash, converted_markets = nil) # string, hash, hash
        market_hashes = convert_hash[bc]
